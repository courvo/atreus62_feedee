 ...
 * |--------+------+-----+-------+-----+-----| Esc | | Ent |------+-----+-----+-----+-----+--------|
 * | LCtrl  | LGui | Alt | LCtrl | Spc | Del |     | |     | Bksp | Fn1 | Fn4 |  =  | Fn3 | RCtrl  |
 * `---------------------------------------------' '---------------------------------------------'
 */
[_DEF] = {
...
{ MO(_FN2), KC_A,    KC_S,    KC_D,    KC_F,   KC_G,    _______, KC_H,    KC_J,     KC_K,     KC_L,   KC_SCLN,  KC_QUOT },
{ KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,    KC_ESC,  KC_N,    KC_M,     KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT },
{ KC_LCTL,  KC_LGUI, KC_LALT, KC_LCTL, KC_SPC, KC_DELT, KC_ENT,  KC_BSPC, MO(_FN1), MO(_FN4), KC_EQL, MO(_FN3), KC_RCTL }
},
...
{ _______, KC_EXLM, KC_AT,   KC_HASH, KC_AMPR, KC_LBRC,  _______,  KC_RBRC, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______ },
{ _______, KC_EQL,  KC_MINS, KC_PLUS, KC_UNDS, KC_LPRN,  _______,  KC_RPRN, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______ },
{ _______, KC_PERC, KC_DLR,  KC_CIRC, KC_ASTR, KC_LCBR,  _______,  KC_RCBR, _______, _______, _______, _______, _______ },
{ _______, _______, _______, _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______ }
},

/* FN 2 (Left, media keys)
 * ,----------------------------------.       .-------------------------------------.
 * |        |   |   |   |      |      |       |      |  Pwr  | Sleep | Wake |   | ⏏ |
 * |--------+---+---+---+------+------|       |------+-------+-------+------+---+---|
...
[_FN4] = {
{ _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ },
{ _______, _______, _______, _______, _______, _______, _______, _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______ },
{ _______, _______, _______, _______, _______, _______, _______, _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______ },
{ _______, _______, _______, _______, _______, _______, _______, _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______ },
{ _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ }
},
